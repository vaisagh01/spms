...
=======
# Generated by Django 5.1.5 on 2025-02-19 18:11
>>>>>>> Stashed changes
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='curricular.department')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_type', models.CharField(choices=[('Mid Semester', 'Mid Semester'), ('End Semester', 'End Semester'), ('Lab', 'Lab'), ('Other', 'Other')], default='Other', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alumni', to='curricular.department')),
            ],
            options={
                'verbose_name': 'Alumni',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hard_skills', models.TextField(blank=True, help_text='Comma-separated skills', null=True)),
                ('soft_skills', models.TextField(blank=True, help_text='Comma-separated skills', null=True)),
                ('phone_number', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student', to='curricular.department')),
            ],
            options={
...
<<<<<<< Updated upstream
                ...
                ('designation', models.CharField(choices=[('HOD', 'Head of Department'), ('Assistant Professor', 'Assistant Professor'), ('Associate Professor', 'Associate Professor'), ('Professor', 'Professor'), ('Doctor', 'Doctor'), ('Lecturer', 'Lecturer')], max_length=50)),
                ('hire_date', models.DateField()),
                ('courses', models.ManyToManyField(blank=True, related_name='teachers', to='curricular.course')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teachers', to='curricular.department')),
=======
                ('phone_number', models.CharField(blank=True, max_length=15, null=True)),
...
<<<<<<< Updated upstream
        ...
        migrations.AddField(
            model_name='course',
            name='class_teacher',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='class_courses', to='curricular.teacher'),
        ),
=======
>>>>>>> Stashed changes
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='curricular.subject')),
